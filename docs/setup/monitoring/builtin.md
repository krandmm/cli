...
```console
$ kubectl apply -f https://raw.githubusercontent.com/kubedb/cli/mongo-doc-upd/docs/examples/monitoring/operator/prom-config.yaml
...
```console
$ kubectl apply -f https://raw.githubusercontent.com/kubedb/cli/mongo-doc-upd/docs/examples/monitoring/operator/prom-deploy.yaml
