...
- You have to push the required images from KubeDB's [Docker hub account](https://hub.docker.com/r/kubedb/) into your private registry. For mysql, push `DB_IMAGE`, `TOOLS_IMAGE`, `EXPORTER_IMAGE` of following MySQLVersions, where `deprecated` is not true, to your private registry.
  ...
  8.0-v2    8.0       kubedb/mysql:8.0-v2   kubedb/mysql-tools:8.0-v2   kubedb/mysqld-exporter:v0.11.0   <none>
  ```
...
- Update KubeDB catalog for private Docker registry. Ex:
  ...
  spec:
    ...
    tools:
      image: "PRIVATE_DOCKER_REGISTRY/mysql-tools:8.0-v2"
...
```console
$ kubedb create -f https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/mysql/private-registry/demo-2.yaml
