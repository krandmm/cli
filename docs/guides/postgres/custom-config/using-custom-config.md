...
```console
$ kubectl create configmap -n demo pg-custom-config --from-literal=user.conf="$(curl -fsSL https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/postgres/custom-config/user.conf)"
