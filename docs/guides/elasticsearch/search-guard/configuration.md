...
```console
$ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/sg-config/sg_config.yml
```
...
```console
$ curl https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/sg-config/sg_internal_users.yml | envsubst > sg_internal_users.yml
```
...
```console
$ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/sg-config/sg_action_groups.yml
```
...
```console
$ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/sg-config/sg_roles.yml
```
...
```console
$ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/sg-config/sg_roles_mapping.yml
```
...
```console
$ kubectl create -f https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/config-elasticsearch.yaml
