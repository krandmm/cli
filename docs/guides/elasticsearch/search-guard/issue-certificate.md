...
1. Get root certificate configuration file
    ...
    ```console
    $ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/openssl-config/openssl-ca.ini
    ```
...
```console
$ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/openssl-config/openssl-sign.ini
```
...
```console
$ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/openssl-config/openssl-node.ini
...
```console
$ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/openssl-config/openssl-client.ini
...
```console
$ wget https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/openssl-config/openssl-sgadmin.ini
...
```console
$ kubectl create -f https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/search-guard/sg-elasticsearch.yaml
