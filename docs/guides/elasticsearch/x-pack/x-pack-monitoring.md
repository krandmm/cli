...
```console
$ kubectl apply -f kubectl apply -f https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/x-pack/es-mon-demo.yaml
...
```console
$ kubectl apply -f https://raw.githubusercontent.com/kubedb/cli/doc-upd-mrf/docs/examples/elasticsearch/kibana/kibana-deployment.yaml
